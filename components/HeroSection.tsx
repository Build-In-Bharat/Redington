...
export default function HeroSection() {
  ...
  return (
    <div className="relative w-full h-[120vh] flex flex-col justify-center overflow-hidden m-0 p-0 bg-black">
      ...
      <div className="absolute inset-10 z-10 mt-12">
      <Image src={"/laptop.png"} alt="laptop" width={1000} height={1000} className="md:hidden" />
        <div className=" flex items-center">
          <div className="text-white p-6 max-w-2xl text-justify">
            ...
            <h2 className="hidden md:flex text-3xl md:text-4xl lg:text-6xl font-bold mb-6 text-[#4fe6ff] flex-col gap-2">
