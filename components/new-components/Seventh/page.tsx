...
const page = () => {
  return (
    <div className="bg-[#60CDFF] px-4 sm:px-8 lg:px-24 py-8 lg:py-12 flex flex-col lg:flex-row gap-8 lg:gap-12">
      <div className="w-full lg:w-[38vw] text-base sm:text-lg lg:text-xl text-white py-3 lg:py-5">
      ...
      <Image src={"/new-ui/seventh.png"} height={556} width={582} alt="" className="w-full lg:w-[30vw]" />
    </div>
  );
};
